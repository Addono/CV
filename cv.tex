...
% @todo Add the CICD pipeline for the CV
        ...
        \textbf{\href{https://foodathon-solutionsmarket.com}{Foodathon Solutions Market}} - 
...
\begin{twenty} % Environment for a list with descriptions
    \twentyitem
        ...
        {
        \begin{itemize}
            \item Second year of the double degree master from \href{https://masterschool.eitdigital.eu/}{EIT Digital Master Schools}.
        \end{itemize}
        }
    \\
	\twentyitem
        ...
        \begin{itemize}
            ...
            \item GPA of 4.79 / 5.
            \item First year of the double degree master from \href{https://masterschool.eitdigital.eu/}{EIT Digital Master Schools}.
        \end{itemize}
        }
    \\
    \twentyitem
...
\begin{twentyshort} % Environment for a list with descriptions
    \twentyitem
		...
		{Present}
        {Junior Consultant}
		{\href{https://www.eficode.com}{Eficode}}
        {Helsinki, Finland}
        {%
%         \begin{itemize}
% 			\item 
