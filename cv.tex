...
\section{Professional Experience}{
    \customcventry{08/2025 - present}
     {\color{blue}\href{https://epam.com}{EPAM Systems}} % Company here
     {Solution Architect,}
     {Munich, Germany}
     {}{}
     {\vspace{.5em}}

     \customcventry{01/2025 - 08/2025}
     {\color{blue}{Sole Practitioner}} % Company here
     {Freelance Cloud \& DevOps Consultant,}
     {Munich, Germany}
     {}{}
     {\vspace{.5em}}

     \customcventry{09/2021 - 08/2025}
     {\color{blue}\href{https://detectium.io}{Detectium Oy}} % Company here
     {Chief Information Officer,}
     {Helsinki, Finland}
     {}{}
     {\vspace{.5em}}

     \customcventry{01/2021 ‐ 08/2025}
     ...
     {}{}
     {
     	\begin{itemize}[leftmargin=0.6cm, label={\textbullet}]	       		      		    
     		...
     		\item Public speaking at various tech events, sharing insights on cloud technologies, modern CI/CD, and embracing AI.
     		      \begin{itemize}
     		      	\item 
        \inlineLink{https://msevents.microsoft.com/event?id=3020611485}{Developer x AI (2024) by Microsoft}:
        \inlineLink{https://youtu.be/m87d6QFNWTo?si=fKxDBDMf5OgNKnT6&t=2685}{``Experiences from onboarding GitHub Copilot''}
    
    \item
        \inlineLink{https://www.meetup.com/devops-finland/events/293742321/}{DevOps Finland meetup}: 
...
\section{Education}{
    ...
    \vspace{2mm} % Alternative to using itemize
     ...
     {}{}
     {
         \vspace{2mm} % Alternative to using itemize to ensure vertical spacing stays roughly the same
     	% \begin{itemize}[leftmargin=0.6cm, label={\textbullet}]
		...
		\item Various professionally relevant certifications:
		      {
		      	...
		      	\begin{itemize}
		      		\certificateEntry
		      		{https://learn.microsoft.com/en-us/users/addono/credentials/eaae18a7dae42}
