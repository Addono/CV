...
% Projects text
\projects{
        \textbf{\href{https://aknapen.nl/masga}{MAke Sauna Great Again}} - A simple user interface aggregating sensor data from one of Vaisala's saunas. Made during Junction 2018. \emph{\#python \#Google Cloud Functions \#JS} \\
		...
		A web application to track expenses within a group of friends. \emph{\#PHP \#JS \#MySQL \#HTML5} \\
...
\cvmail{mail@aknapen.nl} % Email address
