...
\programming{
    ...
    {JS ~\textbullet~ TS ~\textbullet~ GraphQL ~\textbullet~ Unity~\textbullet~ React / 3.5},
    {Java~\textbullet~ Python~\textbullet~PHP~\textbullet~ HTML5~\textbullet~SQL / 6}}% LaTeX

% Projects text
\projects{
        \textbf{\href{https://gitlab.com/ioteknikringen/teknifront}{TekniLight}} - Full product IoT indoor lighting project. \emph{\#TS \#React \#Python \#CD}
