...
\section{Skills}
{
    \newcommand{\skilled}{\textcolor{black}{*}}
    ...
    \emph{\skilledRecent/\sskilledRecent~Indicates more than 100 / 1000 hours of experience on production systems since January 2023. \\
    \skilled/\sskilled~Indicates more than 100 / 1000 hours of experience on production systems anytime.}
}
...
\begin{itemize}[label=\textbullet]
    \item Participated in numerous hackathons, including Junction 2018, 2019, and 2020, with several first-place wins.
    ...
    \item Contributed to open source projects and utilized continuous integration and deployment practices to automate the deployment of personal projects, including this CV.
\end{itemize}} 
...
\footnotesize % This changes the text size to footnotesize. Replace with \scriptsize if you want it smaller.

\begin{minipage}{\textwidth}
This LaTeX document is \inlineLink{https://github.com/addono/cv}{source-available} and is a derivative work based on a template designed by Yousef, available under the \inlineLink{https://creativecommons.org/licenses/by/4.0/}{Creative Commons CC BY 4.0 License}. Modifications from the \inlineLink{https://www.overleaf.com/latex/templates/modern-simple-ats-friendly-latex-cv/fqxnznxhvdgp}{original source} were made for the purposes of this document.
\end{minipage}
