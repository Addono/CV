...
\begin{twenty} % Environment for a list with descriptions
	...
	{
		\begin{itemize}
			\item Performed a consultancy group project for Trouw Nutrition (part of SHV~Holdings) on the reduction of Antibiotic Growth Promoters in the feed additives industry.
