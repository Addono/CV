...
\programming{
    ...
    % {Java~\textbullet~GraphQL~\textbullet~ Unity~\textbullet~ React / 3.5},
    % {TS ~\textbullet~ Python ~\textbullet~ PHP ~\textbullet~ HTML~\textbullet~SQL / 6}}% LaTeX
  {Java, Scala, Go, C, R~\textbullet~ Unity / 1.5}, % 200+    
  {AWS, GCP, Terraform, Python, PHP, GraphQL / 3.5}, % 600+
  {Azure~\textbullet~ Pulumi~\textbullet~Kubernetes~\textbullet~Next.js /5},
  {TypeScript ~\textbullet~ OpenAPI ~\textbullet~ Nest.js  / 6.0}} % 1000+
...
\cvnumberphone{\href{tel:+31640410001}{+31 6 404 10001}} % Phone number
...
\begin{twenty} % Environment for a list with descriptions
    \twentyitem
        ...
        {
        \begin{itemize}
            \item \href{https://urn.kb.se/resolve?urn=urn:nbn:se:kth:diva-291281}{Thesis on chaos engineering,
    ...
    \twentyitem
        ...
        \begin{itemize}
			...
			\href{https://galaxy.github.com/session/day-1-the-secret-to-writing-high-quality-code-more-efficiently}{GitHub Galaxy: ``The Secret to Writing High-Quality Code''}
                ...
                \item
			\href{https://www.meetup.com/devops-finland/events/293742321/}{DevOps Finland August meetup: }
                \href{https://gh.aknapen.nl/20230823--ai-assisted-development--devops-finland-meetup}{``Empowering Software Developers With AI-Based Coding Assistants''}
...
\begin{twenty} % Environment for a list with descriptions
    ...
    {Jan 2023}
    {}
    {\href{https://www.credly.com/badges/f2b4e861-75b4-43cd-8cb5-98835bf5a2d3/public_url}{Azure Network Engineer Associate (AZ-700)}}
    {Microsoft}
    {}
    {}
